...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div id="right_tools_wrapper">
		...
		<span id="refresh_wrapper" title="<?php echo L('REFRESH_CURRENT_PAGE');?>">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts">
					...
					<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache')): ?><a class="btn btn-small btn-danger" href="javascript:openapp('<?php echo U('admin/setting/clearcache');?>','index_clearcache','<?php echo L('ADMIN_SETTING_CLEARCACHE');?>');"
						 title="<?php echo L('ADMIN_SETTING_CLEARCACHE');?>">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/site')): ?><li>
									<a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','<?php echo L('ADMIN_SETTING_SITE');?>');">
										<i class="fa fa-cog"></i> <?php echo L('ADMIN_SETTING_SITE');?></a>
								</li><?php endif; ?>
							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/user/userinfo')): ?><li>
									<a href="javascript:openapp('<?php echo U('user/userinfo');?>','index_userinfo','<?php echo L('ADMIN_USER_USERINFO');?>');">
										<i class="fa fa-user"></i> <?php echo L('ADMIN_USER_USERINFO');?></a>
								</li><?php endif; ?>
							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/password')): ?><li>
									<a href="javascript:openapp('<?php echo U('setting/password');?>','index_password','<?php echo L('ADMIN_SETTING_PASSWORD');?>');">
										<i class="fa fa-lock"></i> <?php echo L('ADMIN_SETTING_PASSWORD');?></a>
								</li><?php endif; ?>
							<li>
								<a href="<?php echo U('Public/logout');?>">
									<i class="fa fa-sign-out"></i> <?php echo L('LOGOUT');?></a>
							</li>
						</ul>
					</li>
				</ul>
